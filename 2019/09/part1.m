...
%     19, the relative base would be 2019. If the next instruction were 204,
%     -34, then the value at address 1985 would be output.
% 
...
filename = 'input.txt';
opcode = importdata(filename)';

[halt, output] = intcode_computer(opcode, [1], 1)
